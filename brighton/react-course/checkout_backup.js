<div id="checkoutCartSummary" class="hidden-xs">
  <div class="checkout-cart-summary">
    <h3><span data-bind="widgetLocaleText: 'cartSummaryText'"></span> ( <span data-bind="text:cart().allItems().length"></span> )</h3> 
    ...
    <div data-bind="with: productData" class="row cart-summary-product-data">
      ...
      <div class="col-sm-9 cart-details-price-wrapper">
        <div class="row">
          <div class="col-md-7 col-sm-12">
            <div
             ...
             <!-- ko foreach:childSKUs -->
              <!-- ko if:$data.x_size != null -->
              <div class="display-inline">
                <span>Size:</span>, <span data-bind="text:$data.x_size"></span>
              </div>
              <!-- /ko -->
              <!-- ko if:$data.x_width != null -->
               <div class="display-inline">
              <span>Width:</span> <span data-bind="text:$data.x_width"></span>
              </div>
              <!-- /ko -->
               <!-- ko if:$data.x_color != null -->
               <div>
              <span>Color:</span> <span data-bind="text:$data.x_color"></span>
              </div>
              <!-- /ko -->
              
              <!-- ko if:$data.br_style != null -->
               <div>
              <span>Color:</span> <span data-bind="text:$data.br_style"></span>
              </div>
              <!-- /ko -->
          ...
          <div class="col-md-5 col-sm-12 checkout-cart-summary-product-price">
            <span 
              data-bind="attr : { id: 'CC-checkoutCartSummary-itemPrice-'+id+$parent.catRefId}, currency: {price: $parent.itemTotal(), currencyObj: $parents[1].cart().currency}" class="pull-right-text price-height">
            </span>
