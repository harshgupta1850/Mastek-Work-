...
define(
    ...
    function($, ko, pubsub, notifications, CCi18n, CCConstants, navigation, ccLogger, ccNumber, CCRestClient, storageApi, notifier, productCompareSharedViewModel) {
        ...
        return {
            ...
            /*DDF-537 changes below*/
            openFeedback: function(event) {
                var url = 'https://www.surveymonkey.com/s/SGYJDG6'
                TrackGAEvent('event', 'Outbound Link', 'click', url);
            ...
            beforeAppear: function() {
                ...
                /*DDF-497 starts here*/
                if (productCompareSharedViewModel.cartAnniversaryDiscountAmount()) {
                    self.cartAnniversaryDiscountAmount(productCompareSharedViewModel.cartAnniversaryDiscountAmount());
                }
                /*DDF-497 ends here*/
            ...
            onLoad: function(widget) {
                ...
                /*DDF-497 starts here*/
                productCompareSharedViewModel.cartAnniversaryDiscountAmount.subscribe(function(data) {
                    self.cartAnniversaryDiscountAmount(data);
                });
                /*DDF-497 ends here*/
            ...
            showCurrencyDropDown: function() {
                ...
                console.log(CCConstants.VIEWPORT_MOBILE_WIDTH, 'CCConstants.IPAD_STRING')
                var phone = navigator.userAgent.match(CCConstants.VIEWPORT_MOBILE_WIDTH) != null;
                console.log(phone, 'phone')
                var width = $(window).width();
                console.log(width, 'width')
                // if (width < 500) {
                //     $('#CC-header-currency-link').on('click touchstart', function(event) {
                //         console.log(event, 'event');
                //         // this.hideCurrencyDropDown();
                //         var $this = $('#CC-header-currency-link');
                //         $this.parents('#headerCurrencyPicker').addClass('active');
                //         $this.parents('#headerCurrencyPicker').find('.content').css({
                //             "display": "block"
                //         });
                //         // debugger;
                //     })
                    
                //     $('body').on('click', ':not(.content)', function(){
                //         console.log('box class');
                //         if($('#CC-header-currency-link').hasClass('active')){
                //             this.hideCurrencyDropDown();    
                //         }
                //     });
                // }
